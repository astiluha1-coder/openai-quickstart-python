...
def get_sys(profile):
    """Формирование системной инструкции для ИИ"""
...
def chat():
    ...
    if user["step"] == "HOOK":
        ...
        # Обычный чат: берем контекст последних 6 сообщений
        ...
        try:
            if client:
                # ВНИМАНИЕ: Если модель gpt-5-mini недоступна, замени на gpt-4o-mini
    ...
    # Сохранение в историю с ID для анимации skeleton
