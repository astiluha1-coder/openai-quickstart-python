...
# --- МОЗГИ (ОБНОВЛЕНЫ ДЛЯ ДЛИННЫХ ОТВЕТОВ) ---

# Sales: Тут мы кратки. Не даем пользу бесплатно.
SYSTEM_SALES = "You are a Fitness Sales Consultant. Be brief. Your ONLY goal is to sell the $20 plan. Do not give advice."

# Coach: ТУТ МЫ ВКЛЮЧАЕМ РЕЖИМ "ПРОФЕССОР".
SYSTEM_COACH = """
...
3. Explain the "WHY". Don't just say "eat protein". Say "Protein is crucial for muscle repair because..."
4. Structure your text: Use Bold, Bullet points, and Emojis to make long text readable.
...
<head>
    ...
    <style>
        ...
        .msg { max-width: 85%; padding: 14px 18px; border-radius: 18px; font-size: 15px; line-height: 1.5; } /* Чуть увеличил ширину для длинных текстов */
...
<body>
    ...
    <div class="chat-box" id="chat">
        <div class="msg bot">Hey! 👋 Let's achieve your dream body. Do you have a subscription key?</div>
    </div>

    <div id="paywall" class="lock-screen hidden">
        <div class="lock-title" id="lock-title">🔒 DEMO ENDED</div>
        <p id="lock-msg">You've reached the limit.<br>Subscribe to get your plan.</p>
    ...
    <script>
        ...
        function activatePremium() {
            ...
            updateUI(true);
            setTimeout(() => {
                document.getElementById("chat").innerHTML += `<div class="msg bot">✅ VIP ACCESS GRANTED. I am now configured to provide deep, detailed plans. What is your goal?</div>`;
            }, 500);
        }
        ...
        async function sendMessage() {
            ...
            if (msgCount >= limit) {
                ...
                if(isPremium) {
                    ...
                    document.getElementById("lock-msg").innerText = "Daily limit reached (20/20).\nSee you tomorrow.";
                } else {
